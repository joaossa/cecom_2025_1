...
import paisRouter from "./modules/paises/pais.router";
import cidadeRouter from "./modules/cidades/cidade.router";
import unidadeFederacaoRouter from "./modules/unidades-federacao/unidade-federacao.router";
...
app.use("/unidades-federacao", unidadeFederacaoRouter);
